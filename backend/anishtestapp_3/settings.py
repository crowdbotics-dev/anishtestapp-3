"""
Django settings for anishtestapp_3 project.
...
ROOT_URLCONF = 'anishtestapp_3.urls'
...
WSGI_APPLICATION = 'anishtestapp_3.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "anishtestapp_3 API",
    "DESCRIPTION": "API documentation for anishtestapp_3 App",
    "VERSION": "v1",
}
